...
FIREBASE_CRED_PATH = os.path.join(BASE_DIR, "wakeupwars_private_key.json")
...
SECRET_KEY = 'django-insecure-jk+$_mq@s!_)h%q&(gu*2wsdy=%8^78kf$$o$flf(@%_zl07e0'
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=60),     # default 7 days
}
