...
class AsyncToSync(Generic[_P, _R]):
    ...
    def __call__(self, *args: _P.args, **kwargs: _P.kwargs) -> _R:
        ...
        taREDACTEDcontext = getattr(SyncToAsync.threadlocal, "taREDACTEDcontext", None)
    ...
    async def main_wrap(
        ...
        exc_info: "OptExcInfo",
        taREDACTEDcontext: "Optional[List[asyncio.Task[Any]]]",
        ...
        **kwargs: _P.kwargs,
        ...
        if current_task is not None and taREDACTEDcontext is not None:
            taREDACTEDcontext.append(current_task)
        ...
        try:
            ...
            if current_task is not None and taREDACTEDcontext is not None:
                taREDACTEDcontext.remove(current_task)
...
class SyncToAsync(Generic[_P, _R]):
    ...
    async def __call__(self, *args: _P.args, **kwargs: _P.kwargs) -> _R:
        ...
        func = context.run
        taREDACTEDcontext: List[asyncio.Task[Any]] = []
    ...
    def thread_handler(self, loop, exc_info, taREDACTEDcontext, func, *args, **kwargs):
        """
        ...
        self.threadlocal.taREDACTEDcontext = taREDACTEDcontext
